...
<div class="container productList">
		<div class="span6">
			<div class="hotProductCategory">
				<c:forEach items="${csMap}" var="c">
						<dl>
							<dt>
								<a href="${pageContext.request.contextPath}/product_findByCid.action?cid=${c.key.cid}">${c.key.cname}</a>
							</dt>
								<c:forEach items="${c.value}" var="cs">
									<dd>
										<a href="${ pageContext.request.contextPath }/product_findByCsid.action?csid=${cs.csid}">${cs.csname}</a>
									</dd>
								</c:forEach>
						</dl>
				</c:forEach>
