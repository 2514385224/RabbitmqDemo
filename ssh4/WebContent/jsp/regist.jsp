...
<script>
	...
	function checkName()
	{
		...
		// 3.打开连接
		xhr.open("POST","${pageContext.request.contextPath}/user_findByName2.action?time="+new Date().getTime()+"&name="+name,true);
		// 4.发送
		xhr.send(null);
	}
	function checkEmail()
	{
		...
		// 3.打开连接
		xhr.open("POST","${pageContext.request.contextPath}/user_findByEmail2.action?time="+new Date().getTime()+"&email="+email,true);
		// 4.发送
		xhr.send(null);
	}
	function checkPhone()
	{
		...
		// 3.打开连接
		xhr.open("POST","${pageContext.request.contextPath}/user_findByPhone2.action?time="+new Date().getTime()+"&phone="+phone,true);
		// 4.发送
		xhr.send(null);
	}
	...
	function checkUserName(){
		...
		// 3.打开连接
		xhr.open("POST","${pageContext.request.contextPath}/user_findByUserName2.action?time="+new Date().getTime()+"&username="+username,true);
		// 4.发送
		xhr.send(null);
	}
							...
							<tr>
								...
								<td>
									...
									<tr>
										...
										<td>
												<input type="text" name="name" class="text" maxlength="200" onblur="checkName()"/>
												<span id="span3">123</span>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
												<input type="text" name="phone" class="text" onblur="checkPhone()"/>
												<span id="span4">123</span>
										</td>
									</tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="code" class="text captcha" maxlength="4" autocomplete="off"><img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" onclick="change()" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
