							...
							<table>
								...
								<tr>
									...
									<c:forEach items="${cart}" var="o">
											<tr>
												<td width="60">
													<img src="${pageContext.request.contextPath}/${o.key.image}">
												</td>
												<td>
												...
												<td width="140">
													<span class="subtotal">￥${o.value.subtotal}</span>
												</td>
												<td>
													<a href="${ pageContext.request.contextPath }/cart_removeCart.action?pid=${o.key.pid}" class="delete">删除</a>
												</td>
											</tr>
									</c:forEach>
